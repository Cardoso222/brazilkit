...
O seu CNPJ vai continuar validando quando os alfanuméricos entrarem em circulação? Com `brutils`, sim:

```ts
import { isValidCnpj } from 'brutils/cnpj'
...
```ts
import { generatePixCode, parsePixCode } from 'brutils/pix'
